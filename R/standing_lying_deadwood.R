...
#' result <- Apply_LyingDeadwood(data, "Yes", "Thinning", "Yes", "plot_id", "ldt", "L_tot", "Dhalf", "TH_tot", "DBH", 10000)
#' }
#'
#' @import dplyr
#' @importFrom dplyr %>%
...
#' \dontrun{
#' data <- read.csv("forest_inventory.csv")
#' result <- Apply_StandingDeadwood(data, "Yes", "Thinning", "Yes", "plot_id", "sdt", "L_tot", "Dhalf", "TH_tot", "DBH", 10000)
#' }
#'
#' @import dplyr
#' @importFrom dplyr %>%
...
#' \dontrun{
#' data <- read.csv("forest_inventory.csv")
#' result <- Apply_All_Deadwood(data, "Yes", "Thinning", "Yes", "plot_id", "Height", "D_max", "D_min", 10000)
#' }
#'
#' @import dplyr
#' @importFrom dplyr %>%
